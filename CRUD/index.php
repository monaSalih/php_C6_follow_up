            ...
            <tbody>
              <?php
                ...
                foreach($users as $user){
                  ...
                  <td><a href='./delete_data/delete_page.php?id={$user['student_id']}'>delete</a>
                  <a href='./update_data/update_page.php?id={$user['student_id']}'>edit</a>
                  </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="./insert_data/insert_new.php" method="post">
                        <div class="mb-3">
